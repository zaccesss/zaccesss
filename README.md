...
My technical development includes **C, C++, Python and Java** with knowledge of microcontrollers, embedded systems, IoT fundamentals, PCB design, MATLAB, debugging and algorithmic thinking. I am also expanding skills in **HTML, CSS, cloud computing, basic AI systems, cyber security and game development engines.**

I enjoy understanding how systems function internally and building projects that move from concept to code to real output. My **4×4×4 NeoPixel LED Cube** reflects this blend through C++ logic, power budgeting and prototyping.
...
- Soldered and assembled full cube  
- Programmed animation engine and behaviour patterns  

`[Repository coming soon on this profile]`  

More builds in progress around embedded automation, sensor based IoT and PCB boards.
...
At Adisadel I was involved in Robotics, APOSA, Scripture Union, PENSA, Debate Society, Sports and Athletics while serving as APOSA Vice President. These activities built leadership, public speaking, teamwork and faith based responsibility.
...
- **Yunex Traffic Smart Mobility & Digital Tech**  
...
- **Ghana High Commission – Consular and Administrative roles**  
  Worked with documentation, passports and visas while developing diplomacy, organisation, documentation and communication skills.

- **Hospitality roles in London**  
  Waiter, food runner and bar back roles which strengthened teamwork, customer service, focus and performance under pressure across busy environments.
